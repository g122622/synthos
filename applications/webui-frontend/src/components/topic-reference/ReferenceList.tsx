    ...
    return (
        <Card className="w-full shadow-none bg-transparent">
            <CardHeader className="flex gap-3">
                ...
                <button className="flex items-center gap-1 text-small text-default-500 hover:text-default-700 transition-colors" type="button" onClick={() => setIsCollapsed(!isCollapsed)}>
