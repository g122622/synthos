        ...
        <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 w-full max-w-6xl">
                <Card className="max-w-full">
                    ...
                    <CardFooter>
                        <Button as={RouterLink} color="primary" to="/chat-messages" variant="shadow">
                            查看聊天记录
                        </Button>
                    </CardFooter>
                </Card>
                ...
                <Card className="max-w-full">
                    ...
                    <CardFooter>
                        <Button as={RouterLink} color="primary" to="/ai-digest" variant="shadow">
                            查看摘要结果
                        </Button>
                    </CardFooter>
                </Card>
                ...
                <Card className="max-w-full">
                    ...
                    <CardFooter>
                        <Button as={RouterLink} color="secondary" to="/ai-chat" variant="shadow">
                            开始问答
                        </Button>
                    </CardFooter>
                </Card>
                ...
                <Card className="max-w-full">
                    ...
                    <CardFooter>
                        <Button as={RouterLink} color="primary" to="/groups" variant="shadow">
                            管理群组
                        </Button>
                    </CardFooter>
                </Card>
