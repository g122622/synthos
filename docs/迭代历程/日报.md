...
- `common/database/ReportDBManager.ts` - 新增日报数据库管理器
...
- `webui-backend/src/lifecycle/dbInitialization.ts` - 初始化 ReportDBManager
- `webui-backend/src/index.ts` - 注册 ReportDBManager
