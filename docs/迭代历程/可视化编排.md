...
```13:160:d:/FR_Projects/synthos/applications/orchestrator/src/index.ts
/**
 * Pipeline 执行顺序（严格串行）:
...
```178:192:d:/FR_Projects/synthos/common/scheduler/jobUtils.ts
...
```60:203:d:/FR_Projects/synthos/applications/orchestrator/src/schedulers/reportScheduler.ts
