...
import { markTopicAsFavorite, removeTopicFromFavorites, markTopicAsRead } from "@/api/readAndFavApi";
...
const TopicCard: React.FC<TopicCardProps> = ({ topic, index = 0, interestScore, favoriteTopics = {}, readTopics = {}, onToggleFavorite, onMarkAsRead }) => {
        ...
        <Card className="border border-default-200">
            <CardHeader className="flex flex-col gap-2 relative">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <HeroUIButton isIconOnly size="sm" variant="light" onPress={handleCopyTopic}>
                        <Copy size={16} />
                    </HeroUIButton>
                </div>
            </CardHeader>
